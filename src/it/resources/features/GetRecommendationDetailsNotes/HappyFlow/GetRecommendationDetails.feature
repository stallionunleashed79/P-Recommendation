@270716
Feature: As a foresight user, when I retrieve a recommendation's details, I need to see the details of the recommendation's link in the response
  Background:
...
#    And I expect each object in "links" array to contain "url"
#    And I expect each object in "links" array to contain "attachedDate"
