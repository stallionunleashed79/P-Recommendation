@301558
Feature: Feature: As a CMA in foresight, I should be able to filter recommendations with a contains filter
  Background:
  ...
  @smoke
  Scenario Outline:  Successfully search with containsFilter
    Given I am a "CMA" in Foresight
    And I have a valid request to search recommendations with a "serialNumber" contains filter with value "rjg"
