@301558
Feature: Feature: As a CMA in foresight, I should be able to filter recommendations by multiple filters
  Background:
  ...
  @smoke
  Scenario Outline:  Successfully search recommendations with multiple filters
    Given I am a "CMA" in Foresight
    And I have a valid request to search recommendations with multiple filters with entries "serialNumber", "rjg", "recommendationStatus", "Draft"
